...
import { getPendingSetsListAction, getSetByAdminAction } from '@/redux/approve-sets/slice'
import { routerPaths } from '@/routes/path'
import { replacePathWithId } from '@/lib/utils'

const PendingSetsListPage = () => {
    const { data, pagination, isLoading } = useSelector((state: any) => state.ApproveSet)
