...
function* watchGetTestHistoryBySetId() {
  yield takeLatest(
    getTestHistoryBySetIdAction.type,
    function* ({ payload }: PayloadAction<any>): Generator<any, void, any> {
